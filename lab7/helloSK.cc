...
//  _cstring_i_cstring
class _0RL_cd_d45bbb1e61dc04ae_00000000
  : public omniCallDescriptor
{
public:
  inline _0RL_cd_d45bbb1e61dc04ae_00000000(LocalCallFn lcfn,const char* op_,size_t oplen,_CORBA_Boolean upcall=0):
...
void _0RL_cd_d45bbb1e61dc04ae_00000000::marshalArguments(cdrStream& _n)
{
  _n.marshalString(arg_0,0);

}

void _0RL_cd_d45bbb1e61dc04ae_00000000::unmarshalArguments(cdrStream& _n)
{
...
void _0RL_cd_d45bbb1e61dc04ae_00000000::marshalReturnedValues(cdrStream& _n)
{
  _n.marshalString(result,0);

}

void _0RL_cd_d45bbb1e61dc04ae_00000000::unmarshalReturnedValues(cdrStream& _n)
{
  result = _n.unmarshalString(0);

}

const char* const _0RL_cd_d45bbb1e61dc04ae_00000000::_user_exns[] = {
  0
};

// Local call call-back function.
static void
_0RL_lcfn_d45bbb1e61dc04ae_10000000(omniCallDescriptor* cd, omniServant* svnt)
{
  _0RL_cd_d45bbb1e61dc04ae_00000000* tcd = (_0RL_cd_d45bbb1e61dc04ae_00000000*)cd;
  _impl_Hello* impl = (_impl_Hello*) svnt->_ptrToInterface(Hello::_PD_repoId);
  tcd->result = impl->say_hello(tcd->arg_0);


}

char* _objref_Hello::say_hello(const char* client)
{
  _0RL_cd_d45bbb1e61dc04ae_00000000 _call_desc(_0RL_lcfn_d45bbb1e61dc04ae_10000000, "say_hello", 10);
  _call_desc.arg_0 = client;
...
_impl_Hello::_dispatch(omniCallHandle& _handle)
{
  ...
  if( omni::strMatch(op, "say_hello") ) {
    ...
    _0RL_cd_d45bbb1e61dc04ae_00000000 _call_desc(_0RL_lcfn_d45bbb1e61dc04ae_10000000, "say_hello", 10, 1);
